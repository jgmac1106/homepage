...
<?php include 'header.php'; ?>
  ...
  <h1 class="p-name">#LoveBombs for Thimble: Saying Goodbye to Teacher, Mentor, Friend</h1>
  <div class="pubinfo">
  <p>Published by <a class="p-author h-card" href="https://jgregorymcverry.com">J. Gregory McVerry</a>
     on <time class="dt-published" datetime="2018-12-19 09:33:00">19<sup>th</sup> December 2018</time></p>
  <span class="summary">
    <p class="p-summary">An ode to Thimble and a look to the future</p>
    </span>
 </div>
    <img class="featured u-featured" src="https://cdn.glitch.com/055438aa-8d6a-403c-a7ff-c97119f02627%2FDs-2rTzWkAE5Y3J.jpg?1545143411776">
    <div class="copy">
  <div class="e-content">
    <p>In every teacher's career they need to say goodbye. Our friends, teachers, and mentors leave this world. For any long time contributor to the Mozilla Foundation these goodbyes can often be towards software applications we came to know, love ,and often helped build.</p>
  <p>
  ...
  <p>
    Thimble's roots run as deep as mine. It feels like we had the tool throughout the Mozilla Learning experience (we did, onluy x-ray Goggles and badges are older). When we first started MozLearn was Hackasaurus, and it began with x-ray Goggles, a tool by <span class="h-card">Atul Varma</span> and <a class="h-card u-url" href="https://jessklein.is"><span class="p-name">Jess Klein</span></a> that they built with New York and Chicago Public Libraries. Thimble began as a <a href="https://jessicaklein.blogspot.com/2012/01/on-inspiration-and-lovebombs.html"><span class="p-category">#LoveBomb</span></a>for the web. Atul and Jess then launched a single file editor, called Thimble, and a tool to build apps called Appmaker. Someone built Popcorn, still the coolest HTML5 remix machine to date. At some point during the journey hackasaurus became the webmaker project. 
    </p>
    <p>
      Then in 2013, webmaker would become (a now defunct Android app) Goggles, Popcorn, Thimble, and Appmaker would "sunset." The community got upset. We relied on these tools, and meanwhile behind the scenes <span class="h-card">David Humphry</span> pushed an open source fork of Brackets as an update to Thimble. X-Ray Goggles also lived on. Webmaker became (Mozilla Learning or Mozilla Learning Network...or something....not sure we ever settled on a name before the entire program was shuttered) and a newer better Thimble took life with the work of humph and the awesome design of <span class="h-card">Luke Pacholski</span>
    </p>
    <h2>
      What made Thimble Great?
    </h2>
    <p>
      In 2014-2015 tools for young developers and designers did not exist. Sure you could try GitHub, but at the time you needed Terminal and could not use the web itnerface. An impossible task for y learners. Furthermore engineers find it difficult to grok the difference between tutorials and documentation. Pointing someone to a README.md does not lead to learning. We added tools to Thimble that worked in the classrooom because it was developed in the classroom. <a href="https://jgregorymcverry.com/thirty-days-with-thimble/">My classroom.</a> Thimble got learning right. We:
    </p>
    <ul>
      <li>Added tutorial files</li>
      <li>Embraced remix</li>
      <li>Included links to shortcuts</li>
      <li>Had live preview of code changes</li>
      <li>Created a community to develop curriuclum</li>
      <li>Onboarded open source development</li>
    </ul>
    <p>
      The spread of Thimble across the globe amazes me. Projects got remixed tens of thousands of times. I watched the real time analytics. The number of unique and returning visitors astounded me. The "Welcome Back to School" javascript kits last year got remixed close to 30,000 times in one week. One week. 
    </p>
    <h2>
      Why must Thimble Go?
    </h2>
