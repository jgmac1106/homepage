...
<?php include 'header.php'; ?>
  ...
  <div class="e-content">
     <ul>
      ...
      <li>Choose Known and then select your new domain or subdomain. make sure to instal in https</li>li>
      ...
      <li>Copy this line into Terminal. It updates to the latest version: git clone <code>https://github.com/idno/known.git</code></li>
      ...
      <li>Then paste this line into Terminal <code>cd known; composer install</code></li>
      <li>When that is done paste the following line into Terminal to remove a file permissions error: <code>find . -type f | xargs -i{} chmod 644 {}</code></li>
