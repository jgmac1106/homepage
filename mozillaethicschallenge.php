...
<?php include 'header.php'; ?>
  ...
  <p>Published by <span class="p-author h-card">Lisa Lancor</span> and <a class="u-author h-card" href="https://jgregorymcverry.com">Greg McVerry</a>
     ...
     <small>Featured Image: <a href="https://assets.mofoprod.net/network/images/hero-cs-challenge2x.original.jpg">by Mozilla</a> </small>
  <span class="summary">
    <p class="p-summary">Using WebVr to Advance Ethics in Computer Science.</p>
    </span>
 </div>
    <img class="featured u-featured" src="https://assets.mofoprod.net/network/images/hero-cs-challenge2x.original.jpg">
    <div class="copy">
  <div class="e-content">
    <h2>
      Project Purpose
    </h2>
    <p>Southern Connectiuct State University supports one of the oldest research centers of the ethics of compouters and technology. Through this Responsible CS Challenge Grant we will bring this long tradition to Modern browsers by having students develop ethical case studies in computer science using webVR. </p>
    <h2>
      Concept Summary
    </h2>
    <p>
    ...
    <p>
      ...
      <ul>
        <li>Virtual reality recording studio</li>
        <li>webVR editing stations</li>
        <li>Approximatley 15 webVR case studies on ethics in computer science</li>
        <li>Two course sequence on developing webVR with a lens towards ethics</li>
        <li>Network of studnet blogs, reflections, and posts</li>
      </ul>
      </div>
    <h2>
      Suitability
