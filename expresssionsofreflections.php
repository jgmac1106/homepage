...
<?php include 'header.php'; ?>
  ...
  <h1 class="p-name">Expressions of Reflections </h1>
  <div class="pubinfo">
  <p>Published by <a class="p-author h-card" href="https://jgregorymcverry.com">J. Gregroy McVerry</a> 
     on <time class="dt-published" datetime="2020-02-16 12:54:20">16<sup>th</sup> February 2020</time></p>
    ...
    <span class="summary">
    <p class="p-summary">A #Clmooc #poetryport gift for @karenatsharon using  the word expression. </p>
    </span>
  </div>
<img class="featured u-featured" src="https://i1.wp.com/clmooc.com/wp-content/uploads/2020/01/PoetRY_Port_LogoYes-lowres-e1580420665271.png?fit=800%2C800&ssl=1" alt="screenshot of my notes">
    <div class="copy">
  <div class="e-content">
    <video controls src="https://jgregorymcverry.com/videos/ExpressionsOfReflections.mp4"></video><br/>
When Piper glances<br/>
Bard<br/>
reflections of<br/>
expressions in<br/>
contrary states<br/>
...
Constraints<br/>
on creativity<br/>
in a marriage of fates.<br/>
If it is God that is<br/>
within us<br/>
then it must be Satan who<br/>
dims us<br/>
      </div>
