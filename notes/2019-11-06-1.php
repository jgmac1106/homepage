...
<time class="dt-published" datetime="<?php echo date('Y-m-d H:i:s') ?>"><?php echo date('Y-m-d H:i:s') ?></time>
 <div class="p-name e-content"><p>Thx @JRDingwall I just added</p><ul><li class="h-card"><a class="p-name u-url" href="https://rickscafe.wordpress.com/" rel="colleague"><img class="u-photo" src="https://1.gravatar.com/avatar/42a9ddd0020442fee60b06f2a8aeaa53?s=128&d=identicon&r=G">Richard Schwier</a><span class="p-note"> 
  ...
  <a class="u-url url" href="https://jgregorymcverry.com<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, "utf-8"); ?> "rel="canonical"><strong>My Notes</strong></a> <a href="https://jgregorymcverry.com/notes/2019-11-05-2" rel="prev">Previous Note</a> <a href="https://jgregorymcverry.com/notes/2019-11-06-2" rel="next">Next Note</a>
